...
- `slack-mcp>=0.0.1` - Slack MCP Server core (if not already installed)
...
- **Docker Compose**: For integrated testing with other services
...
3. 🔧 **[How to Run](./how-to-run)** - Usage examples and patterns
4. 📚 **[API Reference](../api-references/)** - Complete API documentation
...
python3.13 -m pip install be-component-loader-redis
```
...
pip install --user be-component-loader-redis
