...
# Verify installation
pip show be-component-loader-redis
```
...
# Install the package
uv pip install be-component-loader-redis

# Verify installation
uv pip show be-component-loader-redis
```
...
```bash
# Add to your project
poetry add be-component-loader-redis

# Verify installation
poetry show be-component-loader-redis
```
...
For a complete development environment with Redis and your application:
...
pip install --no-cache-dir be-component-loader-redis
...
pip uninstall be-component-loader-redis
pip install be-component-loader-redis
...
1. 🔧 **[How to Run](./how-to-run)** - Learn usage patterns and examples
2. 📚 **[API Reference](../api-references/)** - Explore the complete API
3. 🤝 **[Contributing](../contribute/)** - Help improve the Redis backend

Ready to start using the Redis backend? Check out the [How to Run guide](./how-to-run)!
